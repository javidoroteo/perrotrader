...
const LoginButton = ({ variant = 'primary', fullWidth = false, showIcon = true }) => {
  ...
  const variants = {
    primary: `${baseStyles} bg-gradient-to-r from-blue-500 to-purple-600 text-white hover:from-blue-600 hover:to-purple-700 shadow-lg hover:shadow-xl px-6 py-3`,
