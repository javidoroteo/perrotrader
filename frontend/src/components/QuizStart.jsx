...
import { Brain, Target, Shield, ArrowRight, TrendingUp } from 'lucide-react';
...
const QuizStart = ({ onStart, loading }) => (
  <div className="text-center space-y-10 fade-in">
    ...
    <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto my-12">
      {[
        { icon: <Brain className="w-8 h-8" />, title: "Análisis Psicológico", desc: "Evaluamos tu relación con el riesgo", gradient: "from-purple-500 to-purple-600" },
        { icon: <Target className="w-8 h-8" />, title: "Objetivos Personalizados", desc: "Definimos metas específicas", gradient: "from-blue-500 to-blue-600" },
        { icon: <Shield className="w-8 h-8" />, title: "Estrategia Segura", desc: "Recomendaciones basadas en datos", gradient: "from-green-500 to-green-600" }
      ].map((feature, i) => (
