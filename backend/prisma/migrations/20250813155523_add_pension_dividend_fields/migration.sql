...
INSERT INTO "new_quiz_sessions" ("createdAt", "cryptoScore", "currentQuestionId", "emergencyFund", "esgValue", "experienceScore", "expiresAt", "id", "isCompleted", "portfolioData", "riskProfile", "timeValue", "totalScore", "updatedAt") SELECT "createdAt", "cryptoScore", "currentQuestionId", "emergencyFund", "esgValue", "experienceScore", "expiresAt", "id", "isCompleted", "portfolioData", "riskProfile", "timeValue", "totalScore", "updatedAt" FROM "quiz_sessions";
